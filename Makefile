...
src/server/kvs: src/common/protocol.h src/common/constants.h src/server/main.c src/server/operations.o src/server/kvs.o src/server/dirmanager.o src/server/parser.o src/common/io.o
	$(CC) $(CFLAGS) $(SLEEP) -o $@ $^
